 ...
 *
 * @param iThreadIdXInDispatch      Global X ID of the thread in dispatch.
 * @param iThreadIdYInDispatch      Global Y ID of the thread in dispatch.
 * @param iThreadGroupXIdInDispatch X ID of the thread group.
 * @param iThreadGroupYIdInDispatch Y ID of the thread group.
 * @param iThreadIdInGroup          ID of the thread in a group.
 */
