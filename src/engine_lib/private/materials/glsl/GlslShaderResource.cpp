...
namespace ne {
    ...
    std::variant<std::unique_ptr<ShaderCpuReadWriteResource>, Error> GlslShaderCpuReadWriteResource::create(
        ...
        //                "unable to find a shader resource by the specified name \"{}\", make sure the
        //                resource name " "is correct and that this resource is actually being used inside of
        //                your shader (otherwise " "the shader resource might be optimized out and the engine
        //                will not be able to see it)", sShaderResourceName));
        //        }
        ...
        //        return std::unique_ptr<GlslShaderCpuReadWriteResource>(new GlslShaderCpuReadWriteResource(
        //            sShaderResourceName,
        //            iResourceSizeInBytes,
