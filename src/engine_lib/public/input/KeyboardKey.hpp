...
namespace ne {
    ...
    /**
     * Represents keyboard key and provides @ref getName function.
     */
    class KeyboardKey {
    public:
        /**
         ...
         */
        constexpr KeyboardKey(const Value key) : key(key) {}
         ...
         * @return Keyboard key.
         */
        explicit constexpr operator Value() const { return key; }
         ...
         */
        bool operator==(const KeyboardKey &other) const { return key == other.key; }
        ...
        std::string getName() const {
            const auto pName = glfwGetKeyName(key, 0);
            if (!pName)
                return "";
            else
                return pName;
