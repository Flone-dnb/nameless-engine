...
TEST_CASE("find valid HLSL shader cache") {
    ...
    result = IShader::compileShader<HlslShader>(description, cacheInvalidationReason);
...
TEST_CASE("invalidate HLSL shader cache - ENTRY_FUNCTION_NAME_CHANGED") {
    ...
    REQUIRE(cacheInvalidationReason.has_value());
    REQUIRE(cacheInvalidationReason.value() == ShaderCacheInvalidationReason::ENTRY_FUNCTION_NAME_CHANGED);
...
TEST_CASE("invalidate HLSL shader cache - DEFINED_SHADER_MACROS_CHANGED") {
    ...
    REQUIRE(cacheInvalidationReason.has_value());
    REQUIRE(cacheInvalidationReason.value() == ShaderCacheInvalidationReason::DEFINED_SHADER_MACROS_CHANGED);
...
TEST_CASE("invalidate HLSL shader cache - SHADER_SOURCE_FILE_CHANGED") {
    ...
    REQUIRE(cacheInvalidationReason.has_value());
    REQUIRE(cacheInvalidationReason.value() == ShaderCacheInvalidationReason::SHADER_SOURCE_FILE_CHANGED);
